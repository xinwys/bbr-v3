...
1. **一键运行**  
   ```bash
   bash <(curl -l -s https://raw.githubusercontent.com/xinwys/bbr-v3/refs/heads/main/install.sh)
   ```
...
**Q: 如果不小心把系统搞崩了怎么办？**  
A: 别慌！记得备份你的内核，或者到 [xin's Blog](https://www.199520.xyz) 查看修复教程。
...
**xin**  
📖 官网：[xinBlog](https://www.199520.xyz)  
